...
const WORDS = ["Web Developer",  "Graphics Designer", "UI/UX Designer", "App Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Musagoje" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/musaibrahimgoje" },
  { icon: Instagram, link: "https://www.instagram.com/musaibrahimgoje" }
];
